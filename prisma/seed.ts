...
async function main() {
  ...
  const signatureLadoo = await prisma.category.upsert({
    where: { slug: "signature-ladoo" },
    update: {},
    create: {
      name: "Signature Ladoo",
      slug: "signature-ladoo",
      description: "Premium signature varieties with rich ingredients",
    },
  });

  const veganLadoo = await prisma.category.upsert({
    where: { slug: "plant-based-ladoo-vegan" },
    update: {},
    create: {
      name: "Plant-Based Ladoo (Vegan)",
      slug: "plant-based-ladoo-vegan",
      description: "100% plant-based ladoos without ghee or dairy",
    },
  });
  ...
  // Signature Ladoo Products (500g box)
  await prisma.product.upsert({
    where: { slug: "premium-signature-dry-fruit-ladoo" },
    update: {},
    create: {
      name: "Premium Signature Dry Fruit Ladoo",
      slug: "premium-signature-dry-fruit-ladoo",
      description: "Our signature blend of almonds, cashews, pistachios, and dates in pure desi ghee. Box of 8 ladoos (500g).",
      price: 850,
      comparePrice: 950,
      stock: 40,
      weight: 0.5,
      images: ["https://via.placeholder.com/600x600.png?text=Signature+Dry+Fruit"],
      categoryId: signatureLadoo.id,
      brand: "LADOOZI",
      highlights: ["Premium dry fruits", "500g box", "Pure desi ghee", "Signature recipe"],
      featured: true,
      active: true,
    },
  });
  ...
  await prisma.product.upsert({
    where: { slug: "signature-kesar-badam-ladoo" },
    update: {},
    create: {
      name: "Signature Kesar Badam Ladoo",
      slug: "signature-kesar-badam-ladoo",
      description: "Luxurious saffron and almond ladoos with premium ingredients. Box of 8 ladoos (500g).",
      price: 900,
      comparePrice: 1000,
      stock: 30,
      weight: 0.5,
      images: ["https://via.placeholder.com/600x600.png?text=Kesar+Badam"],
      categoryId: signatureLadoo.id,
      brand: "LADOOZI",
      highlights: ["Real saffron", "Premium almonds", "500g box", "Royal taste"],
      featured: true,
      active: true,
    },
  });

  // Vegan Ladoo Products (200g box)
  await prisma.product.upsert({
    where: { slug: "vegan-dates-nuts-ladoo" },
    update: {},
    create: {
      name: "Vegan Dates & Nuts Ladoo",
      slug: "vegan-dates-nuts-ladoo",
      description: "100% plant-based ladoos made with dates, nuts, and seeds. No ghee, no dairy. Box of 8 ladoos (200g).",
      price: 480,
      comparePrice: 530,
      stock: 50,
      weight: 0.2,
      images: ["https://via.placeholder.com/600x600.png?text=Vegan+Dates"],
      categoryId: veganLadoo.id,
      brand: "LADOOZI",
      highlights: ["100% vegan", "No ghee", "No dairy", "200g box"],
      featured: true,
      active: true,
    },
  });
  ...
  await prisma.product.upsert({
    where: { slug: "vegan-coconut-jaggery-ladoo" },
    update: {},
    create: {
      name: "Vegan Coconut Jaggery Ladoo",
      slug: "vegan-coconut-jaggery-ladoo",
      description: "Plant-based coconut ladoos sweetened with jaggery. Perfect for vegan diet. Box of 8 ladoos (200g).",
      price: 420,
      comparePrice: 470,
      stock: 45,
      weight: 0.2,
      images: ["https://via.placeholder.com/600x600.png?text=Vegan+Coconut"],
      categoryId: veganLadoo.id,
      brand: "LADOOZI",
      highlights: ["100% vegan", "Fresh coconut", "Jaggery sweetened", "200g box"],
      featured: false,
      active: true,
    },
  });
